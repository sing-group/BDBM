...
public class RefineAnnotationCommandDialog extends CommandDialog {
	private static final long serialVersionUID = 1L;

	public RefineAnnotationCommandDialog(
		BDBMController controller, 
		RefineAnnotationCommand command
	) {
	...
	@ComponentForOption(RefineAnnotationCommand.OPTION_GENOME_REGION_FASTA_SHORT_NAME)
	...
	@ComponentForOption(RefineAnnotationCommand.OPTION_ANNOTATION_FASTA_SHORT_NAME)
	private Component createComponentForAnnotationFastaOption(
		final FileOption option,
		final ParameterValuesReceiver receiver
		) {
		return ComponentFactory.createComponentForSequenceEntityValues(
